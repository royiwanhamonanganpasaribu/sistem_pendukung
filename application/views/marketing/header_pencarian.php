...
<body>
    ...
    <?php  $this->load->view('marketing/tampilan_menu_marketing'); ?>
    <!-- Left Panel -->
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="<?php echo base_url(); ?>assets/gambar/logo.png" height="55" width="222" alt="Logo"></a>
            ...
            <div class="top-right">
                <div class="header-menu">
                        ...
                        <li>
                             <a href="marketing/logout"> <i class="fa fa-key"> &nbsp;</i>Log Out </a>
                        </li>
